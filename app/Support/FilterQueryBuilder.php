...
class FilterQueryBuilder
{
    ...
    /** @return mixed */
    public function apply(mixed $query, mixed $data)
    {
     ...
     * @return mixed
     */
    public function contains(array $filter, mixed $query)
    {
     ...
     * @return mixed
     */
    protected function makeOrder(mixed $query, array $data)
    {
     ...
     * @return mixed
     */
    protected function makeFilter(mixed $query, array $filter)
    {
    ...
    protected function isNestedColumn(mixed $column): bool
    {
