...
class Create extends Component
{
    ...
    #[Validate('nullable|string|max:255', message: 'The address field must be a string with a maximum of 255 characters.')]
    public ?string $address = null;

    #[Validate('nullable|string|max:255', message: 'The city field must be a string with a maximum of 255 characters.')]
    public ?string $city = null;

    #[Validate('nullable|string|max:255', message: 'The country field must be a string with a maximum of 255 characters.')]
    public ?string $country = null;

    #[Validate('nullable|numeric|max:255', message: 'The tax number field must be a numeric value with a maximum of 255 characters.')]
