...
class SalesReturnController extends Controller
{
    ...
    {
        abort_if(Gate::denies('sale return access'), 403);
    ...
    {
        abort_if(Gate::denies('sale return create'), 403);
    ...
    {
        abort_if(Gate::denies('sale return_update'), 403);
    ...
    {
        abort_if(Gate::denies('sale return_delete'), 403);
