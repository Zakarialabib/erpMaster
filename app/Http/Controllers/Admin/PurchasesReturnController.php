...
class PurchasesReturnController extends Controller
{
    ...
    {
        abort_if(Gate::denies('purchase return access'), 403);
    ...
    {
        abort_if(Gate::denies('purchase return_show'), 403);
    ...
    {
        abort_if(Gate::denies('purchase return_update'), 403);
    ...
    {
        abort_if(Gate::denies('purchase return_delete'), 403);
