...
class PurchasePaymentsController extends Controller
{
    ...
    {
        abort_if(Gate::denies('purchase payment access'), 403);
    ...
    {
        abort_if(Gate::denies('purchase payment create'), 403);
    ...
    {
        abort_if(Gate::denies('purchase payment_update'), 403);
    ...
    {
        abort_if(Gate::denies('purchase payment_delete'), 403);
