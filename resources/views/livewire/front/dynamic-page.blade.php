        ...
        <section class="w-full border-y-2 border-y-gray-400 border-opacity-70">
            ...
            <div class="flex flex-col justify-center">
                @if ($settings['is_title'])
                    <div class="uppercase inline-flex pt-6 px-10 relative">
                        <div class="h-6 w-6 bg-red-500 mx-auto rounded-full z-0 absolute"></div>
                        <h1
                            ...
                            <span class="transition duration-200 ease-in-out">
                                {{ $page->title }}
                            </span>
                        </h1>
                    </div>
            ...
            @if ($settings['is_product'] && $this->categories)
                <div class="w-full px-4 mx-auto">
                    <x-theme.inline-carousel :options="$this->categories" route="front.categoryPage" />
                </div>
            @endif

            @if ($settings['is_offer'])
            ...
            @if ($settings['is_contact'])
                <div class="bg-gray-100 relative px-10 py-10 text-center sm:text-left" id="contact">
                    <div class="mx-auto relative">
                        <p class="text-capitalized text-gray-500 uppercase tracking-[2px] mb-4">
