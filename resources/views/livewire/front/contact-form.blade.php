            ...
            <div class="p-2 w-full">
                <div class="relative">
                    <input type="text" wire:model="contact.name" id="name" name="name"
                        ...
                        class="@error('name') is-invalid @enderror w-full bg-gray-100 dark:bg-white bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-sm outline-none text-gray-700 py-1 px-3 leading-3 transition-colors duration-200 ease-in-out">
            ...
            <div class="p-2 w-full">
                <div class="relative">
                    <input type="email" wire:model="contact.email" id="email" name="email"
                        ...
                        class="@error('email') is-invalid @enderror w-full bg-gray-100 dark:bg-white bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-sm outline-none text-gray-700 py-1 px-3 leading-3 transition-colors duration-200 ease-in-out">
