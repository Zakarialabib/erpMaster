    ...
    <div class="mb-3 px-2">
        ...
        <div class="flex flex-wrap -mx-2 mb-3">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <label for="toggle" class="flex items-center cursor-pointer">
                        <div
                            ...
                            <input id="toggle" type="checkbox" class="sr-only" wire:model.live="featured" checked>
            ...
            <div class="lg:w-1/3 md:w-1/3 sm:w-1/2 px-2">
                ...
                <x-select-list :options="$this->categories" wire:model.live="category_id" name="category_id" id="category_id" />
            </div>
