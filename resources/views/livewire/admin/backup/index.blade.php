        ...
        <section class="py-3 px-4">
            <div class="flex flex-wrap items-center rtl:justify-start justify-between ">
                <div class="mb-5 lg:mb-0">
                    <h2 class="mb-1 text-2xl font-bold">{{ __('Backup') }}</h2>
                ...
                <div class="float-right">
                    <x-dropdown align="right" width="48" class="w-auto mr-2">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link wire:loading.attr="disabled" wire:click="generate">
                                {{ __('Create Backup') }}
                            </x-dropdown-link>


                            <x-dropdown-link wire:loading.attr="disabled" wire:click="backupToDrive">
                                {{ __('Backup to GDrive') }}
                            </x-dropdown-link>

                            <x-dropdown-link
                                href="https://drive.google.com/drive/folders/{{ env('GOOGLE_DRIVE_FOLDER_ID') }}"
                                target="_blank">
                            ...
                            <x-dropdown-link wire:loading.attr="disabled" type="button" wire:click="settingsModal">
                                {{ __('Settings') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                                    ...
                                    <x-table.tr>
                                        ...
                                        <x-table.td>
                                            <div class="flex justify-start space-x-2">
                                                ...
                                                <x-button danger wire:click="delete('{{ $backup }}')"
