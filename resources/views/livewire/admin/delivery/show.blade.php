            ...
            <div class="flex flex-wrap">
                <div class="w-1/2">
                    <div class="border border-gray-300 p-4">
                        {!! SimpleSoftwareIO\QrCode\Facades\QrCode::format('svg')->style('square')->size(400)->eye('circle')->generate($this->delivery?->reference) !!}
                    </div>
                </div>
                <div class="w-1/2">
                    <div class="border border-gray-300 p-4">
                ...
                <div class="w-1/2">
                    <div class="border border-gray-300 p-4">
                        <h2 class="text-lg font-bold mb-4">Sender</h2>
                        <div class="lg:w-1/2 sm:w-full px-2">
                            <x-label for="shipping_id" :value="__('Shipping')" />
                            {{ $this->delivery?->shipping->title }}
                        </div>
                        <div class="lg:w-1/2 sm:w-full px-2">
                            <x-label for="shipping_id" :value="__('Shipping amount')" />
                            {{ $this->delivery?->shipping->amount }}
                        </div>
                        <div class="lg:w-1/2 sm:w-full px-2">
