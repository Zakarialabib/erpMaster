<div>
    ...
    <x-theme.breadcrumb :title="__('Cash Register List')" :parent="route('admin.cash-register.index')" :parentName="__('Cash Register List')">
        <x-button primary type="button" wire:click="dispatchTo('admin.cash-register.create', 'createModal')">
