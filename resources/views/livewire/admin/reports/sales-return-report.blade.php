                        ...
                        <x-table.tbody>
                            @forelse($sale_returns as $sale_return)
                                <x-table.tr>
                                    ...
                                    <x-table.td>
                                        <a href="{{ route('admin.customer.details', $sale_return->customer->id) }}"
                                    ...
                                    <x-table.td>
                                        ...
                                        @endphp
                                        <x-badge :type="$badgeType">{{ $salereturn?->status->label() }}</x-badge>
                                    ...
                                    <x-table.td>
                                        ...
                                        @endphp
                                        <x-badge
                                            :type="$type">{{ $sale_return->payment_status->label() }}</x-badge>
