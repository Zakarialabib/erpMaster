<div>
    ...
    <x-theme.breadcrumb :title="__('Expenses List')" :parent="route('admin.expenses.index')" :parentName="__('Expenses List')">
        <x-button primary type="button" wire:click="dispatchTo('admin.expense.create', 'createModal')">
            {{ __('Create Expense') }}
        </x-button>
    </x-theme.breadcrumb>
