            ...
            <form wire:submit="create">
                <div class="flex flex-wrap -mx-2 mb-3">
                    <div class="md:w-1/2 sm:w-full px-3">
                        ...
                        <x-input wire:model.blur="expense.reference" id="reference" class="block mt-1 w-full" type="text"
                            required />
                        <x-input-error :messages="$errors->get('expense.reference')" class="mt-2" />
                    </div>
                    <div class="md:w-1/2 sm:w-full px-3">
                        <x-label for="date" :value="__('Date')" required />
                        <x-input-date wire:model.blur="expense.date" name="date" type="date" required />
                    ...
                    <div class="md:w-1/2 sm:w-full px-3">
                        ...
                        <x-input wire:model.blur="expense.amount" id="amount" class="block mt-1 w-full"
                            type="text" required />
                    ...
                    <div class="w-full px-3">
                        ...
                        <textarea
                            class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                            rows="2" wire:model="expense.details" id="details"></textarea>
