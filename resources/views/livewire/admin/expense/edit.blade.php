            ...
            <form wire:submit="update">
                <div class="flex flex-wrap -mx-2 mb-3">
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        ...
                        <x-input wire:model.blur="expense.reference" id="expense.reference" type="text" required />
                        <x-input-error :messages="$errors->get('expense.reference')" class="mt-2" />
                    </div>
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        <x-label for="expense.date" :value="__('Date')" />
                        <x-input-date wire:model.blur="expense.date" id="expense.date" name="expense.date"
                            required />
                    ...
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        ...
                        <select required
                            ...
                            id="category_expense" name="category_expense" wire:model.live="expense.category_id">
                    ...
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        ...
                        <select
                            class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                            id="warehouse_expense" name="warehouse_expense" wire:model.live="expense.warehouse_id">
                            <option value=""></option>
                    ...
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        ...
                        <x-input wire:model.blur="expense.amount" id="expense.amount" type="text" required />
                    ...
                    <div class="w-full px-4 mb-4">
                        ...
                        <textarea
                            class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                            rows="6" wire:model.blur="expense.details" id="expense.details"></textarea>
