                ...
                <div class="flex flex-wrap -mx-3 space-y-0">
                    ...
                    <div class="xl:w-1/2 md:w-full px-2">
                        ...
                        <x-select-list
                            ...
                            id="language_id" name="language_id" wire:model="featuredbanner.language_id" :options="$languages" />
                    ...
                    <div class="xl:w-1/2 md:w-full px-2">
                        ...
                        <x-select-list
                            class="block bg-white text-gray-700 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            id="product_id" name="product_id" wire:model="featuredbanner.product_id" :options="$this->products />
