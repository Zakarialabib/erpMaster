<div>
    ...
    <x-theme.breadcrumb :title="__('Supplier Detail')" :parent="route('admin.suppliers.index')" :parentName="__('Supplier List')" :childrenName="__('Supplier Detail')"
     :children="URL::Current()" >
    <h2 class="mb-1 text-2xl font-bold">
        {{ __('Supplier Detail') }} : {{ $supplier->name }}
    </h2>
    </x-theme.breadcrumb>
    <div class="w-full">
                                ...
                                <div class="flex justify-start space-x-2">
                                    <x-dropdown align="right" width="56">
                                        ...
                                        <x-slot name="content">
                                            ...
                                            @can('purchase_update')
                                                <x-dropdown-link href="{{ route('admin.purchase.edit', $purchase) }}"
                                                    wire:loading.attr="disabled">
