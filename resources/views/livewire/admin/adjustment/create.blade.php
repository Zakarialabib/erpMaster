<div>
    ...
    <x-theme.breadcrumb :title="__('Create adjustment')" :parent="route('admin.adjustments.index')" :parentName="__('Adjustment')" :children="route('admin.adjustments.create')" :childrenName="__('Create adjustment')">
                                    ...
                                    <x-table.tr wire:loading.class.delay="opacity-50">
                                        ...
                                        <x-table.td>
                                            <input type="text" name="quantities[]" min="1"
                                                wire:model.live="products.{{ $key }}.quantities"
                                                class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
