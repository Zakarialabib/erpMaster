<div>
    ...
    <x-theme.breadcrumb :title="__('Edit Quotation')" :parent="route('admin.quotations.index')" :parentName="__('Quotations List')" :children="URL::Current()" :childrenName="__('Edit Quotation')">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                        ...
                        <select disabled
                            ...
                            @foreach ($this->warehouses as $warehouse)
                                <option value="{{ $warehouse->id }}" @if ($warehouse->id == $this->quotation->warehouse_id) selected @endif>
                                    {{ $warehouse->name }}
                                </option>
                            @endforeach
                        </select>
