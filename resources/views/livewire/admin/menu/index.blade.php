<div>
    ...
    <x-card>
        <div class="flex flex-wrap">
            <div class="w-1/4 p-4 ">
                <x-button type="button" wire:click="predefinedMenu" primary
                            ...
                            <div x-show="isMenuOpen"
                                ...
                                <form wire:submit="update({{ $menu['id'] }})">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="w-full">
                                            <x-label for="name" :value="__('Name')" />
                                            <x-input id="name{{ $index }}" class="block mt-1 w-full" type="text"
                                                name="name" wire:model.lazy="menus.{{ $index }}.name" />
                                            <x-input-error :messages="$errors->get('menu.name')" for="name" class="mt-2" />
                                        </div>
                                        <div class="w-full">
                                            <x-label for="type" :value="__('Type')" />
                                            <select id="type{{ $index }}" class="block mt-1 w-full" name="type"
                                                wire:model.lazy="menus.{{ $index }}.type">
                                        ...
                                        <div class="w-full">
                                            <x-label for="label" :value="__('Label')" />
                                            <x-input id="label{{ $index }}" class="block mt-1 w-full" type="text"
                                                name="label" wire:model.lazy="menus.{{ $index }}.label" />
                                            <x-input-error :messages="$errors->get('menu.label')" for="label" class="mt-2" />
                                        </div>

                                        <div class="w-full">
                                            <x-label for="url" :value="__('URL')" />
                                            <x-input id="url{{ $index }}" class="block mt-1 w-full" type="text"
                                        ...
                                        <div class="w-full">
                                            <x-label for="parent_id" :value="__('Parent ID')" />
                                            <select id="parent_id{{ $index }}" class="block mt-1 w-full" name="parent_id"
                                        ...
                                        <div class="w-full">
                                            <x-label for="new_window" :value="__('New Window')" />
                                            <label class="flex items-center mt-2">
                                                <input id="new_window{{ $index }}" name="new_window" type="checkbox"
                                                    class="form-checkbox" wire:model.lazy="new_window">
                                                <span class="ml-2">{{ __('New Window') }}</span>
                                            </label>
                                            <x-input-error :messages="$errors->get('menu.new_window')" for="new_window" class="mt-2" />
                                        </div>
