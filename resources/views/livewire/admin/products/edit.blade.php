<div>
    ...
    <x-theme.breadcrumb :title="__('Edit Product')" :parent="route('admin.products.index')" :parentName="__('Product List')" children :childrenName="__('Edit Product') . ' ' . $product->name" />
