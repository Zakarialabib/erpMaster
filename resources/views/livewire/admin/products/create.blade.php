                    ...
                    <div class="flex flex-wrap mb-3">
                        <div class="md:w-1/2 sm:w-full px-3">
                            ...
                            <x-input id="code" class="block mt-1 w-full" type="text" name="code"
                                wire:model.blur="product.code" placeholder="{{ __('Enter Product Code') }}" required
                                autofocus />
                        ...
                        <div class="md:w-1/2 sm:w-full px-2">
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="name"
                                wire:model.blur="product.name" placeholder="{{ __('Enter Product Name') }}" required />
                        ...
                        <div class="md:w-1/2 sm:w-full px-2">
                            ...
                            <x-input id="stock_alert" class="block mt-1 w-full" type="text" name="stock_alert"
                                wire:model.blur="product.stock_alert" />
                        ...
                        @foreach ($this->warehouses as $warehouse)
                            <div class="flex items-center w-full gap-2 py-4">
                                ...
                                <div class="w-1/4">
                                    ...
                                    <input type="text" wire:model.blur="productWarehouse.{{ $warehouse->id }}.cost"
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="lg:w-1/3 sm:w-1/2 px-2">
                                ...
                                <x-input id="order_tax" class="block mt-1 w-full" type="text" name="order_tax"
                                    wire:model.blur="product.order_tax" placeholder="{{ __('Enter Tax') }}" />
                            ...
                            <div class="lg:w-1/3 sm:w-1/2 px-2">
                                ...
                                <select
                                    ...
                                    wire:model.blur="product.tax_type" name="tax_type">
                            ...
                            <div class="lg:w-1/3 sm:w-1/2 px-2">
                                ...
                                <x-input id="unit" class="block mt-1 w-full" type="text" name="unit"
                                    wire:model.blur="product.unit" placeholder="{{ __('Enter Unit') }}" />
                            ...
                            <div class="lg:w-1/3 sm:w-1/2 px-2">
                                ...
                                <select wire:model.blur="product.barcode_symbology"
                                    class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                            ...
                            <div class="w-full px-2">
                                ...
                                <textarea wire:model.blur="product.note" name="note"
                                    class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                    rows="3"></textarea>
                            </div>
                        </div>
