    ...
    <div class="flex">
        ...
        <div class="w-3/4 px-4">
                ...
                <div x-show="tab === 'company'">
                    ...
                    <div class="flex flex-wrap -mx-2 mb-3">
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="text" wire:model="settings.company_name" id="company_name"
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="email" wire:model="settings.company_email" id="company_email"
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="text" wire:model="settings.company_phone" id="company_phone"
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="text" wire:model="settings.company_address" id="company_address"
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="text" wire:model="settings.company_tax" id="company_tax"
                                name="company_tax" />
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="text" wire:model="settings.telegram_channel" id="telegram_channel"
                        ...
                        <div class="w-full px-2">
                            ...
                            <x-fileupload wire:model.live="company_logo" :file="$company_logo"
                    ...
                    <div class="flex flex-wrap -mx-2 mb-3">
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-select-list
                                ...
                                wire:model="settings.default_currency_id" :options="$this->listsForFields['currencies']" required />
                        </div>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <select name="default_currency_position" id="default_currency_position"
                                wire:model="settings.default_currency_position"
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <select name="default_date_format" wire:model="settings.default_date_format"
                                class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                required>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-select-list wire:model="settings.default_client_id" id="default_client_id"
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-select-list wire:model="settings.default_warehouse_id" id="default_warehouse_id"
                ...
                <div x-show="tab === 'invoice'">
                    ...
                    <div class="flex flex-wrap -mx-2 mb-3">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-4">
                            ...
                            <x-input type="text" wire:model="settings.invoice_footer_text"
            ...
            <div x-show="tab === 'messaging'">
                ...
                <div class="w-full px-2">
                    <livewire:admin.settings.messaging />
                </div>
            </div>
        </div>
    </div>
