<div>
    ...
    <x-theme.breadcrumb :title="__('Create Sale')" :parent="route('admin.sales.index')" :parentName="__('Sales List')" :children="URL::Current()" :childrenName="__('Create Sale')">
                ...
                <form wire:submit="store">
                    ...
                    <div class="flex flex-wrap px-3 space-x-2">
                        ...
                        <button type="button"
                            ...
                            wire:click="proceed" wire:loading.attr="disabled"
