        ...
        <form wire:submit="store">
            ...
            <div class="mb-4 flex flex-wrap">
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                    ...
                    <x-select-list
                        ...
                        required id="customer_id" name="customer_id" wire:model.live="customer_id" :options="$this->customers" />
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                    ...
                    <x-input id="paid_amount" type="text" wire:model.live="paid_amount" value="{{ $total_amount }}"
