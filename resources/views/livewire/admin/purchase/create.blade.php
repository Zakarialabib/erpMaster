        ...
        <form wire:submit="store">
            <div class="flex flex-wrap -mx-2 mb-3">
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                    ...
                    <x-select-list
                        ...
                        required id="supplier_id" name="supplier_id" wire:model.blur="supplier_id" :options="$this->listsForFields['suppliers']" />
                ...
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                    ...
                    <x-select-list
                        class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                        required id="warehouse_id" name="warehouse_id" wire:model.live="warehouse_id" :options="$this->warehouses" />
            ...
            <div class="flex flex-wrap -mx-2 mb-3">
                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                    ...
                    <select
                        class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                        name="status" id="status" wire:model.blur="status" required>
                ...
                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                    ...
                    <select
                        class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                        wire:model.blur="payment_method" name="payment_method" id="payment_method" required>
                ...
                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                    ...
                    <x-input id="paid_amount" type="text" wire:model.blur="paid_amount" name="paid_amount"
                        required />
            ...
            <div class="mb-4">
                ...
                <textarea name="note" id="note" rows="5" wire:model.blur="note"
