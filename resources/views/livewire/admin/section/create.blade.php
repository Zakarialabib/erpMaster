            ...
            <form enctype="multipart/form-data" wire:submit="save">
                <div class="flex flex-wrap space-y-2 px-2">
                    ...
                    <div class="lg:w-1/2 sm:w-full px-2">
                        ...
                        <input type="text" name="subtitle" wire:model.lazy="subtitle"
                            class="p-3 leading-5 bg-white text-gray-700 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500 "
                    ...
                    <div class="w-1/3 px-2">
                        ...
                        <input wire:model.lazy="is_form" id="is_form" type="checkbox">
                        <x-input-error :messages="$errors->get('is_form')" for="is_form" class="mt-2" />
                    </div>
