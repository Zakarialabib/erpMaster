<footer class="w-full mt-auto divide-y-2 bg-green-50 border-black border-t-2">
    ...
    <div class="px-6">
        ...
        {{-- <livewire:front.newsletters-form lazy /> --}}

        <div class="grid gap-y-8 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-16">
            <div class="relative">
                <img src="{{ asset('images/' . settings('site_logo')) }}" loading="lazy" alt="{{ settings('site_title') }}"
                    class="h-24 mix-blend-darken">
    ...
    <div class="py-5 dark:border-t-2 dark:border-white/5 dark:bg-none">
        <div class="px-6">
            <div class="flex flex-col items-center justify-between text-center font-bold dark:text-white md:flex-row">
                ...
                <div>{{ __('Need help? Visit the') }} <a href=""
