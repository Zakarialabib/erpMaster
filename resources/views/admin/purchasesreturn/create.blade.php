    ...
    <section class="py-3 px-4">
        <div class="flex flex-wrap items-center rtl:justify-start justify-between ">
            <div class="mb-5 lg:mb-0">
                ...
                <div class="flex items-center">
                    ...
                    <a class="flex items-center text-sm" href="{{ URL::current() }}">
                        ...
                        <span>{{ __('Create Purchase Returns') }}</span>
                    </a>
                </div>
            </div>
            <div class="float-right">
                ...
                {{-- <x-button primary  wire:click="dispatch('createModal')">{{ __('Create') }}</x-button> --}}
            </div>
                ...
                <div class="w-full px-4">
                    <div class="card">
                        <div class="p-4">
                            ...
                            <form id="purchase-return-form" action="{{ route('purchase-returns.store') }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        class="block uppercase mx-auto shadow bg-indigo-800 hover:bg-indigo-700 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded">
                                        {{ __('Create Purchase Return') }} <i class="fa fa-check"></i>
                                    </button>
                                </div>
                            </form>
                        </div>
