            ...
            <div class="mb-5 lg:mb-0">
                ...
                <div class="flex items-center">
                    ...
                    <a class="flex items-center text-sm" href="{{ URL::current() }}">
                        ...
                        <span>{{ __('Edit Purchase Returns') }}</span>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="p-4">
                            ...
                            <form id="purchase-return-form"
                                action="{{ route('purchase-returns.update', $purchase_return) }}" method="POST">
                                @csrf
                                @method('patch')
                                    ...
                                    <div class="w-full md:w-1/3 px-2 mb-2">
                                        <div class="mb-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="reference" required value="{{ $purchase_return->reference }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/3 px-2 mb-2">
                                    ...
                                    <div class="w-full md:w-1/3 px-2 mb-2">
                                        <div class="from-group">
                                            <div class="mb-4">
                                                ...
                                                <input type="date"
                                                    class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                                    name="date" required value="{{ $purchase_return->date }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="w-full md:w-1/3 px-2 mb-2">
                                        <div class="mb-4">
                                            ...
                                            <input id="paid_amount" type="text"
                                                class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                                name="paid_amount" required value="{{ $purchase_return->paid_amount }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        ...
                                        {{__('Update Purchase Return')}} <i class="fa fa-check"></i>
                                    </button>
                                </div>
                            </form>
                        </div>
